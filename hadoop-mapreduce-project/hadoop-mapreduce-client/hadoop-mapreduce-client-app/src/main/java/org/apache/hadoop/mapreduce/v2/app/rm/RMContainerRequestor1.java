 ...
 */
public abstract class RMContainerRequestor1 extends RMCommunicator {
  
  private static final Log LOG = LogFactory.getLog(RMContainerRequestor1.class);
  ...
  public RMContainerRequestor1(ClientService clientService, AppContext context) {
