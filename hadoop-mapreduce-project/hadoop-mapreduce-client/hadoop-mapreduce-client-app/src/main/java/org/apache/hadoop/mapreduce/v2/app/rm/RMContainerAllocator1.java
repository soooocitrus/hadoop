 ...
 */
public class RMContainerAllocator1 extends RMContainerRequestor1
    implements ContainerAllocator {

  static final Log LOG = LogFactory.getLog(RMContainerAllocator1.class);
  ...
  */
  ...
  public RMContainerAllocator1(ClientService clientService, AppContext context) {
    ...
    this.eventHandlingThread = new Thread() {
      ...
      public void run() {
        ...
        while (!stopped.get() && !Thread.currentThread().isInterrupted()) {
          try {
            event = RMContainerAllocator1.this.eventQueue.take();
  ...
  private class ScheduleStats {
    ...
    public void updateAndLogIfChanged(String msgPrefix) {
      ...
      synchronized (RMContainerAllocator1.this) {
