...
public abstract class ResourceRequest implements Comparable<ResourceRequest> {
  ...
  public static ResourceRequest newInstance(Priority priority, String hostName,
    ...
    return newInstance(priority, hostName, capability, numContainers, true, workload);
  }
  ...
  public static ResourceRequest newInstance(Priority priority, String hostName,
    ...
    return newInstance(priority, hostName, capability, numContainers,
        relaxLocality, null, workload);
  }
  @Public
  @Stable
  public static ResourceRequest newInstance(Priority priority, String hostName,
      Resource capability, int numContainers, boolean relaxLocality, 
      String labelExpression, long workload) {
  ...
  /**
   * Get the workload of the request.
   * @return workload of the request.
   */
  @Public
  @Stable  
  ...
  /**
   * Set the workload of the request.
   * @param workload of the request.
   */
  @Public
  @Stable 
