...
public class SchedulerApplicationAttempt {
  ...
  public void updateAppFinishTime(){
	this.appFinishTime = appSchedulingInfo.appFinishTime;
	LOG.info("The updated effectiveWorkload for application_" + this.getApplicationId() + " is " + appFinishTime);
  }
  
  public void updateAppWeight(){
		this.appWeight = appSchedulingInfo.appWeight;
  }
  ...
  public void setAppFinichTime(long time) {
	this.appFinishTime = time;
  }
