...
package org.apache.hadoop.yarn.server.resourcemanager.scheduler.common.fica.bk;
...
public class FiCaSchedulerApp extends SchedulerApplicationAttempt {
  ...
  public synchronized boolean unreserve(FiCaSchedulerNode node, Priority priority) {
    ...
    if (reservedContainers != null) {
      ...
      // unreserved is now triggered in new scenarios (preemption)
      // as a consequence reserved container might be null, adding NP-checks
