...
public class TestYarnApiClasses {
  ...
  public void testResourceRequest() {
    ...
    ResourceRequest original = ResourceRequest.newInstance(priority, "localhost", resource, 2, 100) ;

    ResourceRequest copy = ResourceRequest.newInstance(priority, "localhost", resource, 2, 100);
